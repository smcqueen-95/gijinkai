      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center">
              <span className="text-xl font-display font-bold text-secondary">技尽界</span>
              <span className="ml-2 text-lg font-semibold text-white">Gijinkai Studio</span>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-gray-300">Shibuya Scramble Square</li>
              <li className="text-gray-300">2-24-12 Shibuya</li>
              <li className="text-gray-300">Tokyo, Japan 150-0002</li>
              <li className="text-gray-300">info@gijinkai-studio.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Gijinkai Studio. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <p className="text-sm text-gray-400">
              <span className="font-jp mr-2">技術の限界を超える</span>
              Exceeding the limits of technology
            </p>
          </div>
        </div>
      </div>
